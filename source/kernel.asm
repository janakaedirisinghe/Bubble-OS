;Bubble --- The Bubble Operating System Kernel
;===================================================================
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to Bubble Os OS****************************', 0
	os_version_msg		db 'Version ', BubbleOs_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', BubbleOs_VER, 0

	dialog_string_1		db 'Welcome to Bubble Operating System', 0
